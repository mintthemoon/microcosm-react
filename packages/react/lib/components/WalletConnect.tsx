...
import type { Token, Tokens, WalletConnectProps, Wallet } from "$types"
...
export const WalletConnect = forwardRef<HTMLDialogElement, WalletConnectProps>(({ featuredTokens, align }, ref) => {
  ...
  const renderToken = useCallback((token: Token) => {
    ...
    return (
      <DropdownItem className="vf-wallet-token">
  ...
  const renderDropdownContent = useCallback(() => {
    ...
    return (
      <>
        ...
        {renderTokens()}
        <DropdownItem onClick={disconnect} className="vf-wallet-disconnect">
  ...
  return (
    <Dropdown ref={ref} renderTrigger={renderWalletTrigger} className="vf-wallet" align={align ?? "end"}>
      ...
      <DropdownItem closeDropdown className="vf-wallet-close">
