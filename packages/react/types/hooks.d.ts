...
// VOIDFORGE
export declare const Voidforge: FunctionComponent<VoidforgeProviderProps>
export type VoidforgeCfg = ErrorCfg & ChainCfg & WalletCfg
export type VoidforgeProviderProps = PropsWithChildren<VoidforgeCfg>
...
export type AutoCtxAction<S extends AutoCtxState> = Partial<S> | ((prev: S) => Partial<S>)
...
// ASYNC
export declare const useAsync: <A extends unknown[], R>(
  fnAsync: (...args: A) => Promise<R>,
  onError?: (err: Error) => void,
) => { res: R | undefined; err: Error | undefined; isReady: boolean; fn: (...args: A) => void }
